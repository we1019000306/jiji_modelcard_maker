...
import 'package:jiji_modelcard_maker/states/constants.dart';
...
class JiJiModelOptions {
  const JiJiModelOptions({
  ...
  static JiJiModelOptions of(BuildContext context) {
    final scope =
        context.dependOnInheritedWidgetOfExactType<_ModelBindingScope>()!;
    return scope.modelBindingState.currentModel;
  }

  static void update(BuildContext context, JiJiModelOptions newModel) {
    final scope =
        context.dependOnInheritedWidgetOfExactType<_ModelBindingScope>()!;
...
// Applies text JiJiModelOptions to a widget
...
class ModelBinding extends StatefulWidget {
  ...
  final JiJiModelOptions initialModel;
  final Widget child;
...
class _ModelBindingState extends State<ModelBinding> {
  late JiJiModelOptions currentModel;
  ...
  void handleTimeDilation(JiJiModelOptions newModel) {
  ...
  void updateModel(JiJiModelOptions newModel) {
